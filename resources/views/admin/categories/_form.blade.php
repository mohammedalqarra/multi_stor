...
<div class="form-group">
    ...
    <x-form.input label="Category Name" name="name" class="form-control-lg"
        role="input" :value="$category->name" />
    ...
    <div class="form-group">
        ...
        <x-form.input type="file" id="image" name="image" class="form-control" accept="image/*" />
        @if ($category->image)
